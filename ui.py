...
class GameBoard:
    ...
    def __init__(self, game):
        ...
        self.parentFrame = tk.Frame(self.root, width=self.WIDTH, height=self.HEIGHT)
        self.canvas = tk.Canvas(self.parentFrame, width=self.WIDTH, height=self.HEIGHT)
        #self.canvas.create_window(0,0,anchor='nw', window=self.parentFrame)
        self.parentFrame.grid_propagate(0)

        # Create frames for each section
        self.headerFrame = tk.Frame(self.parentFrame, height=30)
