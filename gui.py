...
class startingScreen(parentScreen):
    ...
    def setupTop(self):
        ...
        ## CHECKBOXES ##
        for i in range(len(self.players)): self.arrayPlayerSelection.append(IntVar())
        ...
        btnQuit = Button(self.start_top, text="Quit", command=self.root.quit).grid(columnspan=3,row=10,column=0)
